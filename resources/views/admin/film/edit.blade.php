      ...
      <div class="content-wrapper">
          ...
          <section class="content">
              <div class="container-fluid">
                  ...
                  <div class="row">
                      <div class="col-12">
                          <form id="form" action="{{route('admin.film.update', $film->id)}}" method="POST" enctype="multipart/form-data" class="ml-4 mb-3">
                            @csrf
                            @method('PATCH')
                              {{-- Поле для названия --}}
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="form-check form-check-inline">
                                    @if($film->release == 1)
                                    <input class="form-check-input" type="radio" name="release" value="1" checked>
