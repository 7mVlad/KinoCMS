                      ...
                      <div class="col-12 mt-5">
                          <form action="{{ route('admin.main-page.update', $mainPage->id ) }}" id="form" method="POST"
                              ...
                              <div class="form-group">
                                  ...
                                  <input type="text" class="form-control w-25" name="phone_two"
                                      placeholder="777 85 98" value="{{ $mainPage->phone_two }}" required>
                              </div>

                              {{-- Поле для описания --}}
                              <div class="form-group w-75 mt-5">
                                  <label>SEO Текст:</label>
                                  <textarea class="form-control" placeholder="Текст" name="seo_text"
                                      style="resize: none; height:150px">{{ $mainPage->seo_text }}</textarea>
                              </div>
